...
describe('services/BotActions', () => {
  it('card-1', () => {
    ...
    expect(underTest.actions).to.eql([Action.TRANSLATOR_PLACE_GOLD_SILVER_2_IF_7_TRANSLATORS,Action.TRANSLATOR_EMPLOY])
  ...
  it('card-3', () => {
    ...
    expect(underTest.actions).to.eql([Action.TRANSLATE_IF_3_SCROLLS,Action.TRAVEL_INFLUENCE_2])
    expect(underTest.benefit).to.undefined
  ...
  it('card-6-wrap-over', () => {
    ...
    expect(underTest.actions).to.eql([Action.INFLUENCE_CARD_PLACE_INFLUENCE_IF_6_TRANSLATORS,Action.TRANSLATOR_EMPLOY])
