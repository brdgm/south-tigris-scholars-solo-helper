<template>
  ...
  <p class="text-muted fst-italic">
    {{t('home.feedback')}}
    <a href="https://boardgamegeek.com/thread/3625930/brdgmme-scholars-of-the-south-tigris-solo-helper-w" target="_blank" rel="noopener">Board Game Geek Thread</a> |
    <a href="https://github.com/brdgm/south-tigris-scholars-solo-helper" target="_blank" rel="noopener">GitHub</a>
  </p>

  <router-link to="/setup" class="btn btn-primary btn-lg mt-3">{{t('action.playGame')}}</router-link>

  <p class="disclaimer">
    This is not an official Garphill Games product and has no affiliation with <a href="https://garphill.com/" target="_blank" rel="noopener">Garphill Games</a>.
    All art in this app is from <a href="https://garphill.com/game-store/scholars-of-the-south-tigris" target="_blank" rel="noopener">Scholars of the South Tigris</a>.
