<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/367041/scholars-of-the-south-tigris" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>S J Macdonald, Shem Phillips</dd>
        <dt>Artist</dt>
        <dd>Mihajlo Dimitrievski</dd>
        <dt>Publisher</dt>
        <dd><a href="https://garphill.com/" target="_blank" rel="noopener">Garphill Games</a></dd>
      </dl>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/south-tigris-scholars-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/south-tigris-scholars-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/south-tigris-scholars-solo-helper</a></dd>
      </dl>
